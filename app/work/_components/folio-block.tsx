...
import { portfolioLinkIconMap } from '@/data/icon-maps';
...
interface FolioBlockProps {
  portfolio: PortfolioItem;
  setCurrentlyOpen: (id: number) => void;
}

export function FolioBlock({
  portfolio,
  setCurrentlyOpen,
}: FolioBlockProps): JSX.Element {
